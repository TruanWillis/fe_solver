...
class Tests(unittest.TestCase):
    ...
    def test_solver_displacement_1(self):
        ...
        self.assertEqual(round(s.__dict__["displacements"]["5v"], 2), round(1, 2))
        ...
        self.assertEqual(
            round(s.__dict__["displacements"]["6v"], 2), round(0.943654, 2)
        )
    ...
    def test_solver_stress_inplane_1(self):
        ...
        self.assertEqual(
            round(s.__dict__["stress_normal"]["s1"]["e1"], -1), round(6923.08, -1)
        )

        self.assertEqual(
            round(s.__dict__["stress_normal"]["s2"]["e1"], -1), round(23076.9, -1)
        )

        self.assertEqual(
            round(s.__dict__["stress_normal"]["s1"]["e8"], -1), round(6923.08, -1)
        )

        self.assertEqual(
            round(s.__dict__["stress_normal"]["s2"]["e8"], -1), round(23076.9, -1)
        )
    ...
    def test_solver_stress_mises_1(self):
        ...
        self.assertEqual(
            round(s.__dict__["stress_mises"]["s_mises"]["e1"], -1), round(20511.2, -1)
        )

        self.assertEqual(
            round(s.__dict__["stress_mises"]["s_mises"]["e8"], -1), round(20511.2, -1)
        )
    ...
    def test_solver_displacement_2(self):
        ...
        self.assertEqual(
            round(s.__dict__["displacements"]["5u"], 3), round(2.74679e-34, 3)
        )

        self.assertEqual(
            round(s.__dict__["displacements"]["5v"], 3), round(0.0149603, 3)
        )
    ...
    def test_solver_stress_inplane_2(self):
        ...
        self.assertEqual(
            round(s.__dict__["stress_normal"]["s2"]["e7"], -1), round(131.513, -1)
        )
    ...
    def test_solver_stress_mises_2(self):
        ...
        self.assertEqual(
            round(s.__dict__["stress_mises"]["s_mises"]["e8"], -1), round(170.328, -1)
        )
